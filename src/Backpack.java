...
Backpack bob= new Backpack();
Pencil patrick= new Pencil();
Ruler rob= new Ruler();
Textbook timmy= new Textbook();

patrick.write("Alex is a Savage");
rob.measure();
timmy.read();
bob.putInBackpack(patrick);
bob.putInBackpack(rob);
bob.putInBackpack(timmy);
bob.goToSchool();
	}
