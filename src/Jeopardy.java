...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		thirdButton = createButton("$10000");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("What is Cubbie's middle name", "Bear", 100);
			firstButton.setText(" ");
		}
		// Call the askQuestion() method
		else if (buttonPressed == secondButton) {
			askQuestion("When is Cubbie's birth month", "April", 2000);
			secondButton.setText(" ");
		} else {
			askQuestion("What is Cubbie's birthday", "April 16", 5000);
			thirdButton.setText(" ");
		}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		// Pop up a message to tell the user the correct answer
			...
			JOptionPane.showMessageDialog(null, "Wrong Answer it is " + correctAnswer);
		}
		// Call the updateScore() method
